...
nohyperreflinkcolor, % links are not colored (comment to color links, for example, to produce an electronic-only version)
...
\keywords{UAV, Variable-Pitch Proprotor System, RTOS, OBC, Wireless Communication} % Please define up to 6 keywords that better describe your work, print it elsewhere with \keywordnames
