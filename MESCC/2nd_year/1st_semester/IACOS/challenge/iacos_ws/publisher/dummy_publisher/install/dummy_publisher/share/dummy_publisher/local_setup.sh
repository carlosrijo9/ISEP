...
: ${AMENT_CURRENT_PREFIX:="/root/iacos_tp/dummy_publisher/install/dummy_publisher"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/dummy_publisher/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/dummy_publisher/environment/path.sh"
