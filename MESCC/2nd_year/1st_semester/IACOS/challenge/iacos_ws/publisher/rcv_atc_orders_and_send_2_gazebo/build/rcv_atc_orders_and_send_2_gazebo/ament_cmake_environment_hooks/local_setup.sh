...
: ${AMENT_CURRENT_PREFIX:="/data/publisher/rcv_atc_orders_and_send_2_gazebo/install/rcv_atc_orders_and_send_2_gazebo"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rcv_atc_orders_and_send_2_gazebo/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rcv_atc_orders_and_send_2_gazebo/environment/path.sh"
