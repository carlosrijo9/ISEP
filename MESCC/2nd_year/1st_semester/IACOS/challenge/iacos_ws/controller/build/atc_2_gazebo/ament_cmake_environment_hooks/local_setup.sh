...
: ${AMENT_CURRENT_PREFIX:="/data/controller/install/atc_2_gazebo"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/atc_2_gazebo/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/atc_2_gazebo/environment/path.sh"
