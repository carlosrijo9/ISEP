...
// Arrays to store data for searching and deleting
...
// Function to search for an item in the linked list by key
int search(linked_list *list, int key, data *result);

// Function to delete an item from the linked list by key
int delete(linked_list *list, int key);

// Function to print the contents of the linked list
void print_linked_list(linked_list *list);

// Function to generate random data for searching
void findDataToSearch();

// Function to generate random data for deleting
...
int main(int argc, char *argv[])
{
    ...
    // Check if the number of threads is specified in the command line arguments
    if (argc < 2)
    {
    ...
    // Generate data for searching and deleting
    findDataToSearch();
    findDataToDelete();
